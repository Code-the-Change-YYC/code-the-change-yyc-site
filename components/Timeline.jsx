    ...
    <div className="flex flex-row flex-start">
      <div className="flex flex-col items-center">
        <img
          ...
          alt=""
          className="box-border h-32 w-36 xsm:h-40 xsm:w-60 sm:h-52 sm:w-80 md:bg-[#BAFBE4] ml-4 mr-8 mt-10 rounded-lg drop-shadow-md"
        />
      ...
      <img
        ...
        alt=""
        className="box-border h-32 w-40 xsm:h-40 xsm:w-64 sm:h-52 sm:w-80 bg-[#A689FF] ml-auto sm:ml-12 mt-16 rounded-l-lg drop-shadow-md"
      />
    </div>
  );
  ...
  const RightTimelineSide = ({ year, description, smallImage, largeImage }) => (
    <div className="flex flex-row flex-start">
      <img
        src={`/images/timeline/${smallImage}`}
        alt=""
        className="box-border h-32 w-40 xsm:h-40 xsm:w-64 sm:h-52 sm:w-80 bg-[#A689FF] mr-8 md:mr-12 mt-16 rounded-r-lg drop-shadow-md"
      />
      {MiddleLine}
      <div className="flex flex-col items-center">
        <img
          src={`/images/timeline/${largeImage}`}
          alt=""
          className="box-border h-32 w-36 xsm:h-40 xsm:w-60 sm:h-52 sm:w-80 bg-[#BAFBE4] mx-8 mt-10 rounded-lg drop-shadow-md"
        />
