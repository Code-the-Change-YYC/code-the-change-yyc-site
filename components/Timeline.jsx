      ...
      <div className={TIMELINE_CONTAINER}>
        <div className="flex flex-row flex-start">
          <div className="flex flex-col items-center">
            <div className="box-border h-32 w-48 bg-[#BAFBE4] mx-8 mt-10 rounded-lg drop-shadow-md" />
          ...
          <div className="box-border h-48 w-48 bg-[#A689FF] ml-8 mt-16 rounded-l-lg drop-shadow-md" />
        </div>
      </div>
      <div className={TIMELINE_CONTAINER}>
        <div className="flex flex-row flex-start">
          <div className="flex flex-col items-center">
            <div className="box-border h-32 w-56 bg-[#A689FF] mr-8 mt-16 rounded-r-lg drop-shadow-md" />
          </div>
          <div className="border-l-4 border-[#7055FD] h-30" />
          <div className="flex flex-col items-center">
            <div className="box-border h-32 w-48 bg-[#BAFBE4] ml-8 mt-10 rounded-lg drop-shadow-md" />
