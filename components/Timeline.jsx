...
const Timeline = () => {
  ...
  const EvenTimelineBlock = ({ year, description, smallImage, largeImage }) => (
    <div className="flex flex-row flex-start">
      <div className="flex flex-col">
        <div className="w-14 mx-[10vw] lg:w-[14.5vw] lg:mx-[5vw] h-32 lg:h-40 mt-10 rounded-xl overflow-hidden drop-shadow-md">
          <Image src={smallImage} alt="Timeline photo" placeholder="blur" layout="fill" objectFit="cover" />
        </div>
      ...
      {MiddleLine}
      <div className="w-14 ml-[7vw] lg:w-[21.5vw] lg:ml-[3.5vw] my-16 rounded-l-xl overflow-hidden drop-shadow-md">
        <Image src={largeImage} alt="Timeline photo" placeholder="blur" layout="fill" objectFit="cover" />
      </div>
    </div>
  );
  ...
  const OddTimelineBlock = ({ year, description, smallImage, largeImage }) => (
    <div className="flex flex-row flex-start">
      <div className="w-14 mr-[7vw] lg:w-[21vw] lg:mr-[3.5vw] my-16 rounded-r-xl overflow-hidden drop-shadow-md">
        <Image src={smallImage} alt="Timeline photo" placeholder="blur" layout="fill" objectFit="cover" />
      </div>
      {MiddleLine}
      <div className="flex flex-col">
        <div className="w-14 mx-[10vw] h-32 lg:h-40 lg:w-[15vw] lg:mx-[5vw] mt-10 rounded-xl overflow-hidden drop-shadow-md">
          <Image src={largeImage} alt="Timeline photo" placeholder="blur" layout="fill" objectFit="cover" />
        </div>
