...
const QUOTES = "md:text-[1.3rem] text-[1.2rem] font-light font-medium italic text-[#000000]";
const QUOTATION_MARK = "text-[2rem] md:text-[2rem] font-extrabold";
const PRESIDENT_YEAR = 'text-[#000000] font-black text-4xl absolute top-6 left:right';
