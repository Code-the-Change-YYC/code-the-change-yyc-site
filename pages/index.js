    ...
    <div className="flex flex-col">
      ...
      <div className="relative flex justify-between bg-[#7055FD] md:bg-white py-60 px-10 md:px-48 rounded-2xl drop-shadow-lg md:drop-shadow-none">
        <img
          ...
          alt="logo_svg"
          className="md:hidden absolute top-0 mx-auto left-0 right-0 pt-16 object-fill w-[400px]"
        />
        <div className=" flex flex-col md:w-1/3">
          ...
          <p className="text-2xl text-white md:text-[#A689FF] font-medium">
            <strong className="md:hidden text-3xl">code the change yyc</strong> is a student-led initiative where
