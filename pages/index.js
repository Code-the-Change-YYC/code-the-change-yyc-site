  ...
  return (
    <div className="flex flex-col -mt-5">
      <div className="relative flex h-screen justify-center items-center">
        ...
        <h1 className="text-stroke-outside text-7xl -mt-20 md:m-0 md:text-9xl font-black w-3/4 md:text-center text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-500 stroke-white drop-shadow-lg">
